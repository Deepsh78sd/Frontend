...
const PageLayout = ({ children, userRole, userName }: PageLayoutProps) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><a href="/adopter/home" className="text-sm text-gray-600 hover:text-teal-500">Home</a></li>
                  <li><a href="/adopter/pets" className="text-sm text-gray-600 hover:text-teal-500">Adopt a Pet</a></li>
                  <li><a href="/adopter/petcare" className="text-sm text-gray-600 hover:text-teal-500">Pet Care</a></li>
                  <li><a href="/adopter/mypets" className="text-sm text-gray-600 hover:text-teal-500">My Pets</a></li>
                </ul>
              </div>
