    ...
    const fetchPet = async () => {
      try {
        ...
        const mockPet = {
          ...
          address: "456 Pet Avenue, Shelter Town",
          photoUrl: "https://images.unsplash.com/photo-1615796153287-53ca0735931a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bWFpbmUlMjBjb29ufGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60",
        };
    ...
    return (
      <ShelterLayout>
        <div className="flex flex-col items-center justify-center min-h-[400px]">
          ...
          <Button asChild>
            <Link to="/shelter/pets">Back to Pets</Link>
          </Button>
        </div>
      </ShelterLayout>
    );
